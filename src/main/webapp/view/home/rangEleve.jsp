...
<% NoteEtudiantModel[] note = (NoteEtudiantModel[]) request.getAttribute("rangEtudiant");%>
...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="container-fluid">
        <!--  Row 1 -->
        <div class="row">
            <h1>Choisir pour voir la matiere de l'etudiant</h1>
                ...
                <div class="card-body p-4">
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tr>
                            ...
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">Moyenne</h6>
                            </th>
                    ...
                    %>
                        <tr>
                            ...
                            <td class="border-bottom-0">
                                <h6 class="fw-semibold mb-0"><%=  list_note.getMoyenne()%></h6>
                            </td>
                            <td class="border-bottom-0">
                                <h6 class="fw-semibold mb-0"><%=  list_note.getRank()%></h6>
                            </td>
                            <td>
                                <form action="/getEtudiantById" method="get">
                                    <input type="hidden" name="id_etudiant" value="<%= list_note.getId_etudiant()%>">
