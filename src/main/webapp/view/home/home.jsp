...
<% ClasseEtudiantModel[] classe = (ClasseEtudiantModel[]) request.getAttribute("classe");%>
<!doctype html>
                    ...
                    <table class="table text-nowrap mb-0 align-middle">
                        ...
                        <tr>
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">id classe</h6>
                            </th>
                            </th>
                        ...
                        <%
                            for(ClasseEtudiantModel list_classe:classe){   
                        %>
                        <tr>
                            <td class="border-bottom-0">
                                <h6 class="fw-semibold mb-0"><%= list_classe.getId_classe()%></h6>
                            </td>
                            <td class="border-bottom-0">
                                <h6 class="fw-semibold mb-0"><%= list_classe.getNom_classe()%></h6>
                            </td>
                            <td>
                                <form action="/getClasseById" method="get">
                                    <input type="hidden" name="id_classe" value="<%= list_classe.getId_classe()%>">
